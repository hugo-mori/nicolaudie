<template>
  <div class="bg-nicolaudie-first">
    <div class="w-64 cursor-pointer border border-nicolaudie-third rounded flex flex-col justify-center items-center text-center p-6 bg-white">
      <div class="text-md font-bold flex flex-col text-gray-900"><span class="uppercase">{{ meteo.location.name }}</span> <span class="font-normal text-gray-700 text-sm">{{ meteo.location.localtime }}</span></div>
      <div class="w-32 h-32 flex items-center justify-center">
        <img class="border-2 border-nicolaudie-first rounded" :src="meteo.current.weather_icons[0]">
      </div>
      <p class="text-gray-700 mb-2">Partly cloud</p>
      <div class="text-3xl font-bold text-gray-900 mb-6">{{ meteo.current.temperature }}º</div>
